...
class FlightinfoS2 extends Component{
    render(){
        return(    
            <Container fluid className="flightinfo-s2 d-flex minh-50vh align-items-center py-5 bg-secondary border-top border-secondary">
